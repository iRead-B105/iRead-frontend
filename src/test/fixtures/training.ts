    ...
    trainings: [
      {
        ...
        questions: [
          {
            questionNo: 1,
            questionType: 'FINAL_SOUND_CHOICE',
            question: {
              instruction: '다음 중 끝소리가 같은 낱말을 고르세요.',
              choices: ['꽃, 옷', '꽃, 낮'],
            },
          ...
          {
            questionNo: 2,
            questionType: 'WORD_READING',
            question: { text: '‘낮’을 소리 내어 읽어 보세요.' },
            responseType: 'AUDIO',
            selectedAnswer: null,
            correctAnswer: '낟',
            correct: false,
      ...
      },
      {
        ...
        questions: [
          {
            questionNo: 1,
            questionType: 'SENTENCE_READING',
            question: { text: '문장을 의미 단위로 나누어 읽어 보세요.' },
            responseType: 'AUDIO',
            selectedAnswer: null,
            correctAnswer: '노란 나비가 / 꽃밭 위를 날아갑니다.',
            correct: null,
          ...
          },
          {
            ...
            question: { prompt: '읽은 문장의 느낌을 적어 보세요.' },
            responseType: 'TEXT_INPUT',
            selectedAnswer: '나비가 천천히 날아가는 느낌입니다.',
            correctAnswer: null,
            correct: null,
            score: null,
          },
